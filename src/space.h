...
public:
    ...
    virtual float distance(const float* seq1, int len1, const float* seq2, int len2) const = 0;
};
...
public:
    ...
    float distance(const float* seq1, int len1, const float* seq2, int len2) const override {
        float sum = 0.0f;
        const float* v1 = seq1;
